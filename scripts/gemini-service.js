...
2. 구조:
   - 오프닝 5초: 통념을 깨는 질문/상황 (인사말 생략)
   - 오프닝 30초: 공감 → 해결책 암시
   - 본문: 시간 분량에 맞춘 에피소드 및 정보
   - 브릿지: 다음 내용이 궁금하게 만드는 연결 멘트
   - 클로징: 여운, 다음 영상 예고, 댓글 유도

[TTS 최적화 및 출력 규칙]

1. 지시문((웃음) 등) 금지, 특수기호 금지.
2. 쉼표(,) 마침표(.)로 호흡 조절.

3. 유튜브 패키지 출력 방식 (중요!):
   - 대본이 끝난 후 구분선(---) 출력.
   - [추천 제목]: 클릭을 부르는 제목 5개
   - [추천 태그]: # 기호 없이 쉼표(,)로만 구분하여 10개 나열 (예: 노후, 친구, 건강, 인생, 행복, 지혜, 가족, 사랑, 용서, 감사)
   - [썸네일]: AI 이미지 생성용 그림 묘사
`,
