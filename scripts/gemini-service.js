...
`,
    ...
    getDurationGuidelines(durationMinutes) {
        const durationMap = {
            8: {
                label: '8분',
                guide: '분량: A4 2~3장 내외 (읽었을 때 약 8분), 짧고 임팩트 있게.'
            },
            10: {
                label: '10분',
            ...
            20: {
                label: '20분',
                guide: '분량: A4 5~6장 (읽었을 때 약 20분), 충분한 이야기와 깊이 있는 감동.'
            },
            30: {
                label: '30분',
            ...
            90: {
                label: '1시간30분',
                guide: '분량: 수면용/장편 낭독 (1시간30분), 여러 에피소드를 엮어 깊은 몰입감 제공.'
            },
            120: {
                label: '2시간',
                guide: '분량: 장편 오디오북 (2시간), 소설처럼 풍부한 서사와 다양한 등장인물로 구성.'
            }
        };
