...
★★★ 대본 분량이 최우선입니다! ★★★
- 이 파트의 대본을 **최소 4,000자 ~ 5,000자** 이상 작성하세요!
- 3~5문장만 쓰고 끝내면 100% 실패입니다!
- 대본이 충분히 길어야 합니다!

★★★ 출력 순서 (반드시 지키세요!) ★★★
1. [SCRIPT] 제목
2. 한글 대본 본문 (최소 4,000자 이상! ← 여기가 가장 중요!)
3. [계속...] 또는 클로징
4. [IMAGE_PROMPTS] (대본 다 쓴 후에만!)
5. [YOUTUBE_PACKAGE] (마지막 파트만)
6. [SAFETY_LOG]

⛔ 대본이 짧으면 이미지 프롬프트가 아무리 많아도 실패입니다!
⛔ 대본 본문에 영어 이미지 프롬프트를 섞으면 실패입니다!
...
[Part 3. 클로징: 위로와 여운] ★★★ 마지막 파트에서만 작성! ★★★
5가지 요소를 순서대로 모두 포함해야 합니다:

🚨🚨🚨 중요: 아래 ①②③④⑤는 작성 가이드일 뿐입니다! 🚨🚨🚨
⛔ 실제 대본에 "(암시)", "(독려)", "(기대)", "(댓글 유도)", "(구독/좋아요 유도)" 같은 라벨을 절대 넣지 마세요!
⛔ 번호나 체크리스트 형식으로 출력하지 마세요!
✅ 자연스러운 문장으로 이어서 작성하세요!

① 암시 (요약 & 활용 강조) - 라벨 없이 자연스럽게!
   - 이 이야기에서 얻을 수 있는 교훈이나 지혜를 암시합니다.
   - 예: "이 이야기를 통해 우리는, 때로는 용서가 자신을 위한 것임을 알 수 있었습니다."

② 독려 (공감 유도) - 라벨 없이 자연스럽게!
   - 청취자의 마음을 어루만지고 공감을 유도합니다.
   - 예: "오늘 들으신 이야기가 여러분의 마음에도 작은 울림이 되셨으면 좋겠습니다."

③ 기대 (채널명 재확인) - 라벨 없이 자연스럽게!
   - 다음 이야기에 대한 기대감과 함께 채널명을 따뜻하게 언급합니다.
   - 예: "다음에도 진솔한 이야기로 찾아뵙겠습니다. 지금까지 6070 인생 라디오 '여울'이었습니다."

④ 댓글 유도 - 라벨 없이 자연스럽게!
   - 시청자가 자신의 경험을 댓글로 남기도록 부드럽게 유도합니다.
   - 예: "여러분의 이야기를 댓글로 들려주세요. 서로에게 큰 위로가 됩니다."

⑤ 구독/좋아요 유도 - 라벨 없이 자연스럽게!
   - 자연스럽고 정중하게 구독과 좋아요를 부탁합니다.
   - 예: "이런 이야기가 마음에 드셨다면, 구독과 좋아요 한번 부탁드립니다. 늘 건강하세요."

★ 올바른 클로징 예시 (라벨 없이 자연스럽게 이어지는 문장):
"이 이야기를 통해 우리는, 때로는 내려놓는 것이 진정한 용기라는 걸 알 수 있었습니다. 
혹시 비슷한 경험이 있으신가요? 여러분의 이야기도 듣고 싶습니다.
다음에도 진솔한 이야기로 찾아뵙겠습니다. 지금까지 6070 인생 라디오 '여울'이었습니다.
댓글로 여러분의 마음을 나눠주시면 함께 위로가 될 것 같습니다.
구독과 좋아요, 알림 설정도 부탁드립니다. 늘 건강하세요."
...
★★★★★ [핵심] 대본 구조 vs 생성 파트 이해하기 ★★★★★
대본은 아래 3가지 섹션으로 구성됩니다:
  - [템플릿 Part 1. 오프닝] = 감성 후킹 + 채널 인사/구독 유도 + 사연 도입
  - [템플릿 Part 2. 본문] = 과거 회상 + 갈등 + 절정 (가장 긴 부분!)
  - [템플릿 Part 3. 클로징] = 해소/성찰 + 작가 첨언 + 채널명 + 최종 CTA

하지만 긴 영상은 여러 번 나눠서 생성합니다:
  - 파트1 생성 = [오프닝 전체] + [본문 앞부분: 과거 회상, 갈등 시작]
  - 파트2 생성 = [본문 중간: 갈등 심화, 절정] (오프닝/클로징 없이 본문만!)
  - 파트3 생성(마지막) = [본문 끝] + [클로징 전체]

🚨 즉, "반갑습니다. 6070 인생 라디오 여울입니다"는 파트1 생성에만!
🚨 파트2, 파트3 생성에서는 본문(스토리)만 이어가세요!
...
★ 파트1, 파트2... (마지막 파트 전): 
  ...
  - [본문] 스토리 중간에서 "[계속...]"으로 끝내세요!
  - 예: "영숙은 아들의 손을 꼭 잡았다. 그리고... [계속...]"

★ 마지막 파트에서만: 
  - [본문] 마무리 + [클로징] 5가지 체크리스트 모두 작성
  - 채널명 언급, 구독/좋아요 유도 등
...
`;
    ...
    if (nextPart === 1) {
        ...
        partSpecificPrompt = `
[파트1 작성 규칙]
- 오프닝: 감성 후킹 + 채널 인사 + 구독 유도 포함
- 본문: 스토리 시작과 전개
- 분량: 최소 4,000자 이상 작성!
- 끝맺음: 클로징 없이 "[계속...]"으로 끝내기 (${totalParts > 1 ? '다음 파트가 있으므로' : '마지막 파트이므로 클로징 포함'})
${totalParts === 1 ? '- 마지막 파트이므로: 클로징 5가지 체크리스트 포함!' : ''}
`;
    } else {
        // ===== 파트2 이후 전용 프롬프트 =====
        partSpecificPrompt = `
...
⛔ 절대 금지:
- "반갑습니다", "인생의 굽이굽이", "6070 인생 라디오", "여울입니다" 등 오프닝 문구 금지!
- 이전 파트 내용 반복/요약 금지!
- 새로운 도입부 작성 금지!

✅ 반드시 해야 할 것:
- 이전 파트 마지막 장면에서 바로 이어지는 다음 장면으로 시작!
- 대화나 행동 묘사로 즉시 시작! (예: "그 순간, 그녀는...")
- 스토리를 앞으로 진행! 새로운 사건과 감정 전개!
- 분량: 최소 4,000자 이상!

${lastSentence ? `
▶ 파트${nextPart - 1} 마지막 장면:
"${lastSentence}"
→ 위 장면의 바로 다음 순간부터 시작하세요!
` : ''}

${isLastPart ? `
✅ 마지막 파트입니다!
- 스토리 완결 + 클로징 5가지 체크리스트 포함
- 채널명, 구독/좋아요 유도 포함
` : `
- 중간 파트입니다! 클로징 없이 "[계속...]"으로 끝내세요!
`}
`;
    }
...
===== 현재 작업 =====
📍 총 ${totalParts}파트 중 ${nextPart}번째 파트 작성
📍 분량: ${duration} / 이 파트 최소 4,000자 이상!
📍 감성: ${selectedTone} - ${toneGuide}

${partSpecificPrompt}

🚨🚨🚨 [가장 중요한 규칙] 완전히 새로운 이야기를 창작하세요! 🚨🚨🚨

아래 "참고용 줄거리"는 **영감을 얻기 위한 재료**일 뿐입니다!
절대로 복사하지 말고, 완전히 다른 이야기를 새로 만드세요!

★ 참고 줄거리에서 가져올 것 (이것만!):
- 주제/테마 (예: 고부갈등, 이혼, 재회 등)
- 분위기/감성 (예: 슬픈, 감동적, 따뜻한 등)

★ 당신이 100% 새로 창작해야 하는 것:
- 🆕 등장인물 이름 → 새로 만들기! (참고 줄거리 이름 사용 금지!)
- 🆕 등장인물 배경/직업/성격 → 새로 만들기!
- 🆕 스토리 전개 → 완전히 다른 이야기!
- 🆕 모든 대사 → 새로 창작!
- 🆕 모든 장면 묘사 → 새로 창작!

⛔ 참고 줄거리와 비슷하면 실패!
⛔ 참고 줄거리의 인물 이름 사용하면 실패!
✅ 완전히 다른 새로운 이야기여야 성공!

예시:
- 참고 줄거리: "김은이(55세)가 며느리와 갈등..."
- 당신이 쓸 것: "박순자(62세)가 아들과 재회..." ← 완전히 다른 인물, 다른 이야기!

===== 이미지 프롬프트 규칙 =====
- 대본 본문에 영어 이미지 프롬프트 섞지 마세요!
- 대본 완성 후 [IMAGE_PROMPTS] 섹션에 15~25개 작성!
${personaInfo}

[참고용 줄거리 - 영감만 얻고 완전히 다른 이야기 쓰기!]
${topic}

${prevStory ? `
[지난 이야기 - 이미 완성된 내용, 이어서 쓰기]
${prevStory}
` : ''}`;
