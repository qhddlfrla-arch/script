...
사용자가 제공하는 대본을 아래 규칙에 따라 활용하세요:

▶ [유지할 것] - 사용자 대본에서 그대로 사용:
1. 스토리 구조와 줄거리 → 그대로 유지!
2. 등장인물 이름 → 그대로 유지!
3. 대사와 상황 설명 → 그대로 유지!
4. 감정과 분위기 → 그대로 유지!

▶ [수정할 것] - 채널 지침에 맞게 수정:
1. ★ 오프닝: 채널 스타일에 맞는 도입부로 수정/보완
   - 5초 후킹 → 갈등/위기 장면으로 시작
   - 호기심 유발 질문 추가
   
2. ★ 클로징: 채널 지침의 5가지 체크리스트 적용
   - 암시: 다음 이야기 예고
   - 독려: 구독/좋아요 유도
   - 기대: 새로운 이야기 예고
   - 댓글 유도: 시청자 참여 요청
   - 채널명 언급: "6070 인생 라디오 '여울'"

3. ★ TTS 최적화: 문단 나누기, 호흡 조절

▶ [작업 흐름]
1. 사용자 대본을 읽고 이해합니다
2. 스토리 본문은 그대로 유지합니다 (이름, 대사, 상황 모두!)
3. 오프닝을 채널 스타일로 다듬습니다
4. 클로징을 채널 지침에 맞게 작성합니다
5. TTS에 적합하도록 문단을 정리합니다
