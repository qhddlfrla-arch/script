...
③ 기대 (채널명 재확인)
   ...
   - ★ 채널명 "6070 인생 라디오 '여울'" 필수 포함!

④ 댓글 유도
   - 시청자가 자신의 경험을 댓글로 남기도록 부드럽게 유도합니다.
   - 예: "여러분의 이야기를 댓글로 들려주세요. 서로에게 큰 위로가 됩니다."
   - 예: "댓글로 여러분의 마음을 나눠주시면 함께 위로가 될 것 같습니다."

⑤ 구독/좋아요 유도
   - 자연스럽고 정중하게 구독과 좋아요를 부탁합니다.
   - 예: "이런 이야기가 마음에 드셨다면, 구독과 좋아요 한번 부탁드립니다."
   - 예: "앞으로도 좋은 이야기 들려드릴게요. 구독과 좋아요, 알림 설정 잊지 마세요."
