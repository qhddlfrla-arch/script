...
${nextPart > 1 ? `
🚨🚨🚨 [파트${nextPart} 전용 규칙 - 매우 중요!] 🚨🚨🚨
★★★ 파트2 이후에는 다음을 절대 작성 금지! ★★★
❌ 오프닝 작성 금지! (새로운 시작 멘트 금지!)
❌ 채널 인사 금지! ("반갑습니다", "6070 인생 라디오 여울입니다" 등)
❌ 구독/좋아요 유도 금지! ("구독과 좋아요 한번 꾹 눌러주시면" 등)
❌ 사연자 소개 다시 금지! ("저는 72세 박춘심입니다" 같은 자기소개 반복 금지!)
...
⚠️ 파트2 이후는 무조건 본문만! 새로운 오프닝 없이 바로 이어가세요!
` : ''}`}
