...
1. 입력에 나온 인물 이름 사용 금지! (미숙, 연이, 수아, 태석 등 → 전혀 다른 이름으로!)
2. 입력에 나온 대사를 그대로 쓰기 금지! (첫 문장부터 완전히 다르게!)
3. 입력에 나온 직업/상황 그대로 쓰기 금지! (검사, 동창회 등 → 다른 직업/상황으로!)
4. 입력 문장을 살짝만 바꿔 쓰기 금지! (단어 몇 개 치환은 표절입니다!)

▶ [반드시 실행] 완전히 새로운 스토리 창작:
1. 새 이름 창작: 봉순, 말자, 옥분, 순덕, 용팔, 만복, 재호 등 입력과 전혀 다른 이름
...
- ✅ 올바른 출력: "시골 장터에 비가 쏟아지는 날이었다. 순임 할머니는 고구마 좌판 앞에서..." (완전히 다른 이야기!)

★ 첫 문장부터 입력과 완전히 달라야 합니다! ★
★ 입력을 참고만 하고, 당신만의 새 이야기를 창작하세요! ★
